...
# from MidwifeAide_Controllers.MA_AppointmentView.MA_EditApp import ViewAppointmentDialog
...
#             uic.loadUi("wfui/midwifeui/add_appointment.ui", self.dialog)
...
#         patLDialog = QDialog()
#         uic.loadUi("wfui/midwifeui/midwife_patientList_appointment.ui", patLDialog)
...
#             uic.loadUi("wfui/midwifeui/mtrash_appointment.ui", self.trashDialog)
