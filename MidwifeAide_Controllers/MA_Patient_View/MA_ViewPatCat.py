...
from MidwifeAide_Controllers.MA_Patient_View.MA_PersonalInfo import PersonalInfoController
from MidwifeAide_Controllers.MA_Patient_View.MA_MaternalRecords import MaternalRecordsController
from MidwifeAide_Controllers.MA_Patient_View.MA_FamPlan import FamPlanController
from MidwifeAide_Controllers.MA_Patient_View.MA_Admission import AdmissionController
from MidwifeAide_Controllers.MA_Patient_View.MA_AppointmentH import AppointmentHistoryController


class ViewPatientDialog(QDialog):
    def __init__(self,patient_id, user_id, parent=None):
        super().__init__(parent)
        uic.loadUi("wfui/mmidwifeui/mview_patient_information.ui", self)
