...
class MAProfileController:
    ...
    def load_admin_info(self):
        ...
        try:
            ...
            cur.execute(""" 
                ...
                WHERE s.STAFF_USN = %s AND r.ROLE_NAME = 'Midwife'
            """, (self.username,))
            result = cur.fetchone()
            ...
            if result:
                ...
                pic_label = self.widget.findChild(QLabel, "labelMidiwifePic")
                if pic_label:
    ...
    def view_edit_dialog(self):
        ...
        uic.loadUi("wfui/midwifeui/view_edit_midwife.ui", self.profile_dialog)
        self.profile_dialog.setWindowTitle("Edit Midwife Profile")
        ...
        widget = self.profile_dialog.findChild(QWidget, "widgetMidwifeProfile")
        pic_label = widget.findChild(QLabel, "labelMidwifePic")
        username_edit = widget.findChild(QLineEdit, "lineEditUsername")
        lname_edit = widget.findChild(QLineEdit, "lineEditMidwifeLname")
        fname_edit = widget.findChild(QLineEdit, "lineEditMidwifeFname")
        contact_edit = widget.findChild(QLineEdit, "lineEditMidwifeContact")
        ...
        upload_btn = widget.findChild(QPushButton, "pushBtnUploadMidwifePic")
        remove_btn = widget.findChild(QPushButton, "pushBtnRemoveMidwifePic")
        save_btn = self.profile_dialog.findChild(QPushButton, "pushBtnSaveMidwife")
        cancel_btn = self.profile_dialog.findChild(QPushButton, "pushBtnCancelMidwife")
        edit_btn = self.profile_dialog.findChild(QPushButton, "pushBtnEditMidwife")
        ...
        try:
            ...
            data = cur.fetchone()
            if not data:
                QMessageBox.warning(self.profile_dialog, "Not Found", "Midwife not found.")
                return
